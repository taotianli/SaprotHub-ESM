            ...
            if self.esm_model is not None:
                ...
                if has_structure_1:
                    ...
                    try:
                        ...
                        print(f"[Pair Dataset Warning] Index {index} - Failed to read PDB1: {str(pdb_error)}, falling back to sequence mode")
                ...
                if has_structure_2:
                    ...
                    try:
                        ...
                        print(f"[Pair Dataset Warning] Index {index} - Failed to read PDB2: {str(pdb_error)}, falling back to sequence mode")
